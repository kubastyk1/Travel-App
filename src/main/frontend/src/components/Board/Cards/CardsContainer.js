...
const listTarget = {
  ...
  hover(props, monitor) {
    ...
    //Own change to disable moving last list row
    if (listId !== nextX && !(listId === props.numberOfRows-1 || nextX === props.numberOfRows-1)) {
    ...
    return connectDragSource(connectDropTarget(
      <div className="desk" style={{ opacity }}>
        ...
        <Cards
          ...
          dayScheduleId={this.props.dayScheduleId}
        />
      </div>
    ));
  }
